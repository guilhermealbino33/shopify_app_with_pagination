    ...
    return (
        <Page>
            <Layout>
                ...
                <Layout.Section>
                    <TextStyle variation='strong'>Total products count: {productCount}</TextStyle>
                </Layout.Section>
                <Layout.Section>
                    <Button disabled={titleValue ? false : true} loading={loading} onClick={handleCreateProductButton} primary>Create product</Button>
                </Layout.Section>
            </Layout>
        </Page>
    )
